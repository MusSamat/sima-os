            ...
            <div className='row mt-5'>
              <div className='col-md-4'>
                <div className='contact-box text-center'>
                  ...
                  >
                    Рынок «Дордой» <br /> 5 проход конт. 458/1
                  </p>
                  <div className='col-sm-6 col-md-8 ml-5'>
                    ...
                    <figure className='footer-payments d-flex '>
                      <img className='mr-4' src={visa} width='52' height='20' />
                      <img src={elcart} width='36' height='10' />
                    </figure>
                  </div>
                </div>
              </div>
              ...
              <div className='col-md-5'>
                <div className='contact-box text-center'>
                  ...
                  <p style={{ fontSize: '18px', color: 'inherit' }}>
                    +996 (705) 55 58 29 Руководитель
                  </p>
                  <p style={{ fontSize: '18px', color: 'inherit' }}>
                    +996 (709) 99 99 15 Менеджер по продажам
                  </p>
                  <p style={{ fontSize: '18px', color: 'inherit' }}>
                    +996 (999) 99 88 15 Менеджер по продажам
                  </p>
                </div>
              </div>
              ...
              <div className='col-md-3'>
                <div className='contact-box text-center'>
                  ...
                  <div className='social-icons social-icons-color justify-content-center'>
                    ...
                    <a
                      style={{ fontSize: '20px', color: '#ee8208' }}
                    ...
                    <a
                      style={{ fontSize: '20px' }}
                      href='https://vk.com/simastyle'
                      className='social-icon'
                    >
                      <img style={{ width: '25px' }} src={vk} />
                    </a>
                  </div>
                  <div className='s-title mt-3'>simastore11@gmail.com</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class='footer-bottom'>
          <div class='container'>
            <p class='footer-copyright'>
              {' '}
              © 2021 Sima Store. All Rights Reserved.
            </p>
            <ul class='footer-menu'>
              <li>
                <a href=''>Sigma Software Solutions</a>
              </li>
            </ul>
          </div>
        </div>
