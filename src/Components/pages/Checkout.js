                ...
                <div className="col-lg-9">
                  ...
                  <div className="row">
                    <div className="col-sm-6">
                      ...
                      />
                      {errors.first_name && (
                        <span className="red">{errors.first_name.message}</span>
                      )}
                    </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      даю согласие на передачу своих персональных данных в Ип
                      «Sima», а также ознакомился(ась) и согласен(на) с
                      правилами и ограничениями по тарифу выбранных товаров.
                    </div>
                  </div>
                  <div>
                    <div
