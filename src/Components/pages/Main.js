        ...
        <div className="page-wrapper">
            <main className="main">
                ...
                <div className="container">
                    ...
                    <p style={{fontSize: "18px"}}>Швейная компания «SIMA» — одна из ведущих производителей женской одежды на рынке Кыргызстана, России, Казахстана, Беларуси и на международном рынке.
                ...
                <div className="container">
                    ...
                    <p style={{fontSize: "18px", marginBottom: " 20px",    }}>Если у Вас остались дополнительные вопросы, пишите <span style={{fontWeight: "500"}}>grand139094@gmail.com</span> Или оставьте заявку на обратный звонок и мы вам перезвоним!
